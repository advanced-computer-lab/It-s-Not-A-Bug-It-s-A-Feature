...
export default function Main(props) {
    ...
    const onSubmit = () => {
        if (d.departureTime != "" && d.departureDate == "") {
            alert('Cannot Add Time without Date');
            setData((prevState => { return { ...prevState, ["departureTime"]: '' }; }));
        }
        if (d.arrivalTime != "" && d.arrivalDate == "") {
            alert('Cannot Add Time without Date');
                                ...
                                <CardContent>
                                    ...
                                    <div>
                                        ...
                                        <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
                                            <Button variant="contained" sx={{ mt: 3, ml: 1 }} id="search" onClick={(e) => {
                                                onSubmit(e);
                                            }}>
                                                Search
                                            </Button>
