  ...
  return (
    ...
    <Stack direction="row" spacing={1}>
       ...
       <Location sx={{ color: 'action.active', mr: 1, my: 2.8 }} />
        <TextField id="input-with-sx" label="City or Airport" variant="standard" 
        ...
        renderInput={(startProps, endProps) => (
          <React.Fragment>
           <DateRangeTwoToneIcon sx={{ color: 'action.active', mr: 1, mt: 1.5 }}/>
             <TextField {...startProps} id="input-with-sx" variant="standard" 
              helperText="Departing"
            />
            <Box sx={{ mx: 3, my :0.5 }}>to</Box>
            <DateRangeTwoToneIcon sx={{ color: 'action.active', mr: 1, mt: 1.5 }}/>
            <TextField {...endProps} id="input-with-sx"  variant="standard" 
            helperText="Arrival" placeholder='mm/dd/yy'
            />
          </React.Fragment>
        )}
      />
   ...
   <Box sx={{ color: 'action.active',display: 'flex', alignItems: 'right',mt:2,mr:1.5}}>
     ...
     <Box  sx={{ display: 'flex', alignItems: 'right',mr:1.5 }}>
        <TextField id="input-with-sx" label="Terminal No" variant="standard" 
        helperText="Departing"/>
        </Box>
      ...
      <Box  sx={{ display: 'flex', alignItems: 'right',mr:1.5}}>
        <TextField id="input-with-sx" label="Flight No" variant="standard" 
